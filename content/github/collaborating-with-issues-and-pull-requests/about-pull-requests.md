...
The compare and pull request pages use different methods to calculate the difference of changed files:

- Compare pages show the difference between the tip of the head reference and the current common ancestor (that is, the merge base) of the head and base reference. 
- Pull request pages show the difference between the tip of the head reference and the common ancestor of the head and base reference at the time when the pull request was created. Consequently, the merge base used for the comparison may differ.
